...
export default function CNCPortfolio() {
  return (
    <main className="min-h-screen bg-white">
      ...
      >
        ...
        >
          Explore our precision CNC manufacturing projects
        </motion.p>
      </div>
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {CNC_CATEGORIES.map((category, index) => (
            <motion.div
              key={category.id}
            ...
            >
              <Link href={`/portfolio/cnc/${category.slug}`}>
